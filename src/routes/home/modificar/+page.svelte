...
<div class="min-h-screen w-full p-8 gap-5 flex flex-col bg-gray-100 xl:w-[60%] lg:w-[50%] md:w-[70%] mx-auto overflow-scroll">
    ...
    {#if constantSelected == 'Tipos'}
        <table class="table-auto w-full rounded-lg bg-white shadow">
            ...
            <tbody class="w-full"> 
                {#each tipos as tipo}
                    <tr onclick={() => {openEditTipoModal(tipo)}} class=" hover:bg-gray-200">
                        <td>{tipo.id_tipo}</td>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="border " ><input type="text" bind:value={tipoSelected.formula_ancho} placeholder="Fórmula ancho"></td>
                                <td class="border " ><input type="text" bind:value={tipoSelected.formula_alto} placeholder="Fórmula alto"></td>
                                <td class="border "><input type="text" bind:value={tipoSelected.cantidad_cristal} placeholder="Cantidad cristal"></td>
                                <td class="border "><input type="number" bind:value={tipoSelected.porcentaje_quinc} placeholder="% Quincallería"></td>
                                <td class="border "><input type="number" bind:value={tipoSelected.largo_perfil} placeholder="Largo perfil"></td>
                                <td class="border "><input type="number" bind:value={tipoSelected.minimo} placeholder="Mínimo"></td>
                                <td class="border "><input type="number" bind:value={tipoSelected.maximo} placeholder="Máximo"></td>
                                <td class="border "><input type="number" bind:value={tipoSelected.ganancia} placeholder="Ganancia"></td>
                            </tr>
                        </tbody>
                    </table>
